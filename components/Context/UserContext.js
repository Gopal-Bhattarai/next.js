...
const UserState = (props) => {
    ...
    // }
      ...
      const getUser = (async (localEmail) => {
              const response = await fetch(`/api/users/email/${localEmail}`,{
                  method: 'get',
                  headers: {
                  'Content-Type' : 'application/json',
    ...
    return (
        <div>
            <UserContext.Provider value={{count, dispatch, getUser, setUser, user,  urlHost}}>
                {props.children}
